    ...
    app.registerController('CtrlCompanyDetail', ['$scope', '$http', '$state', '$stateParams', '$modal',
        function($scope, $http, $state, $stateParams, $modal) {
            ...
            function getData(params) {
                $scope.loading=false
                $http.get('/com/company/json/get/getCompanyInfo', {
            ...
            $scope.changeself=function(e){
                ...
                $http.get('/com/company/json/get/getBankName', {
                    params: {
                        keyword: newValue
                    }
                }).success(function(data, status, headers, config) {
            ...
            $scope.save=function($event){
                ...
                $http.post('/com/company/json/operate/saveAgentCompany', $.param(params)).success(function(data, status, headers, config) {
